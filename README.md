...
### Описание решения
К категориальным признакам ('Sex', 'Housing', 'Checking account', 'Purpose') применили one-hot кодирование.  
К Saving accounts применили порядковое кодирование.  
При выборе модели сравнивались Random Forest Classifier и catboost, для обоих был сделан подбор гиперпараметров через GridSearch. 
